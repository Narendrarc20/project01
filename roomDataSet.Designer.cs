...
namespace AdvancedRoomBookingSystemCSharp {
    ...
    public partial class roomDataSet : global::System.Data.DataSet {
        ...
        public partial class staffDataTable : global::System.Data.TypedTableBase<staffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public staffRow AddstaffRow(string name, string gen, string contact, string addr, string salary, string desig) {
        ...
        public partial class staffRow : global::System.Data.DataRow {
            ...
            public string gen {
                get {
                    try {
                        return ((string)(this[this.tablestaff.genColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'gen\' in table \'staff\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablestaff.genColumn] = value;
                }
            }
            ...
            public string addr {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'addr\' in table \'staff\' is DBNull.", e);
                    }
                }
                set {
            ...
            public string desig {
                get {
                    try {
                        return ((string)(this[this.tablestaff.desigColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsgenNull() {
                return this.IsNull(this.tablestaff.genColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetgenNull() {
                this[this.tablestaff.genColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool IsaddrNull() {
                return this.IsNull(this.tablestaff.addrColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetaddrNull() {
                this[this.tablestaff.addrColumn] = global::System.Convert.DBNull;
            }
...
namespace AdvancedRoomBookingSystemCSharp.roomDataSetTableAdapters {
    ...
    public partial class staffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[staff] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_gen = 1 AND [gen] IS NULL) OR ([gen] = @Original_gen)) AND ((@IsNull_contact = 1 AND [contact] IS NULL) OR ([contact] = @Original_contact)) AND ((@IsNull_addr = 1 AND [addr] IS NULL) OR ([addr] = @Original_addr)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_desig = 1 AND [desig] IS NULL) OR ([desig] = @Original_desig)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[staff] ([name], [gen], [contact], [addr], [salary], [desig]) V" +
                "ALUES (@name, @gen, @contact, @addr, @salary, @desig);\r\nSELECT Id, name, gen, co" +
                "ntact, addr, salary, desig FROM staff WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[staff] SET [name] = @name, [gen] = @gen, [contact] = @contact, [addr] = @addr, [salary] = @salary, [desig] = @desig WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_gen = 1 AND [gen] IS NULL) OR ([gen] = @Original_gen)) AND ((@IsNull_contact = 1 AND [contact] IS NULL) OR ([contact] = @Original_contact)) AND ((@IsNull_addr = 1 AND [addr] IS NULL) OR ([addr] = @Original_addr)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_desig = 1 AND [desig] IS NULL) OR ([desig] = @Original_desig)));
SELECT Id, name, gen, contact, addr, salary, desig FROM staff WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, gen, contact, addr, salary, desig FROM dbo.staff";
        ...
        public virtual int Fill(roomDataSet.staffDataTable dataTable) {
        ...
        public virtual roomDataSet.staffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            roomDataSet.staffDataTable dataTable = new roomDataSet.staffDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(roomDataSet.staffDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_gen, string Original_contact, string Original_addr, string Original_salary, string Original_desig) {
        ...
        public virtual int Insert(string name, string gen, string contact, string addr, string salary, string desig) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string gen, string contact, string addr, string salary, string desig, int Original_Id, string Original_name, string Original_gen, string Original_contact, string Original_addr, string Original_salary, string Original_desig, int Id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string gen, string contact, string addr, string salary, string desig, int Original_Id, string Original_name, string Original_gen, string Original_contact, string Original_addr, string Original_salary, string Original_desig) {
            return this.Update(name, gen, contact, addr, salary, desig, Original_Id, Original_name, Original_gen, Original_contact, Original_addr, Original_salary, Original_desig, Original_Id);
        }
    }
